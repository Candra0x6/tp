...
export class TrustFallGame implements GameInstance {
  ...
  private getEnvironmentTheme(floorNum: number): EnvironmentTheme {
    if (floorNum <= 3) {
      ...
      return {
        name: 'CYBER VAULT',
        bgGrad: ['#021024', '#051b38', '#010816'],
        tileColor1: '#032840',
        tileColor2: '#011929',
        tileBevel: '#0284c7',
        wallColor: '#031e36',
        wallBorder: '#0284c7',
        magicCircleFill: 'rgba(6, 182, 212, 0.2)',
        magicCircleStroke: '#06b6d4',
        pillarColor1: '#032840',
        pillarColor2: '#0f4c75',
        pillarColor3: '#1b7bb8',
        torchHalo: 'rgba(6, 182, 212, 0.4)',
        torchBracket: '#083344',
        flames: ['#06b6d4', '#38bdf8', '#67e8f9', '#cffaffe'],
        particleColors: ['#06b6d4', '#38bdf8', '#a5f3fc', '#67e8f9'],
        doorWoodBase: '#092238',
        doorWoodSelected: '#0284c7',
        doorBandColor: '#083344',
        runeColors: ['#06b6d4', '#38bdf8', '#a5f3fc'],
        accentColor: '#06b6d4',
      };
    } else if (floorNum <= 12) {
      return {
